...
const FloatingInput = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, ...props }, ref) => {
    return <Input placeholder=" " className={cn('peer border-primary/20 bg-transparent! focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-primary/20 focus:border-primary/20', className)} ref={ref} {...props} />;
  },
);
